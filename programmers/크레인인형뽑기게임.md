...
![img](https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/bb0f59c7-6b72-485a-8302-217fe53ea88f/crane_game_104.jpg)
...
baguni라는 배열을 스택의 역할을 하도록 만들고, for 문으로 1번 열부터 돌며 moves 배열의 움직임을 체크하였다. 그 과정에서 baguni의 최상단의 인형과 현재 열의 꼭대기 인형이 같다면 지워주고, 점수를 올려주는 방식으로 처리하였다. 아니라면 바구니에 담아주고, 다음 moves의 배열의 움직임을 다시 체크하는 식이었다.